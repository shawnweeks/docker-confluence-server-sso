...
COPY confluence-seraph-config.xml.j2 /opt/atlassian/sso/seraph-config.xml.j2
COPY confluence-crowd.properties /opt/atlassian/sso/crowd.properties
COPY login.vm.j2 /opt/atlassian/etc/login.vm.j2
COPY entrypoint.py \
